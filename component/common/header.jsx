          ...
          {headData.map((data, index) => {
            return (
              ...
              >
                <Link
                  href="/"
                  className={` ease-in-out duration-[0.3s] p-[15px] block font-[600] text-[18px] ${
                    index === activeTab
                      ? " bg-blue text-white minus-icon"
                      : "bg-skyblue text-black plus-icon"
                  }`}
                ...
                <div
                  key={index}
                  ref={contentEl}
                  className={`inner-content px-[15px] pb-[15px] ${
                    Style.transition
                  } 
                        ...
                        <ul>
                          {inner.links.map((links, index) => {
                            return (
                              <li
                                key={index}
                                className={`py-[10px] ${Style.linkborder}`}
                              >
                                <Link
                                  href="/"
                                  className=" font-[700] text-[16px] leading-[1.2rem] "
                                >
                                  {links.link}
                                </Link>
                              </li>
